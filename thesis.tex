...
\input{tex/documentos-fiscais}

\chapter{A Pandemia de Sars-Cov-2}
\label{chapter:pandemia}
\input{tex/pandemia}

\chapter{Base de Dados}
\label{chapter:base-de-dados}
\input{tex/base-de-dados}

\chapter{Caracterização de Redes Complexas}
\label{chapter:caracterizacao-de-redes-complexas}
\input{tex/caracterizacao-de-redes-complexas}

\chapter{Amostragem de Redes Complexas}
\label{chapter:amostragem-de-redes-complexas}
\input{tex/amostragem-de-redes-complexas}
